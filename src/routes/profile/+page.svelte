<script lang="ts">
	...
	// פרסומות + תביעות בעלות; טיוטות הגילוי הוחרגו בכוונה — לא דחופות),
	// כדי שתמונת הפרופיל וההאדר יראו תמיד את אותו מספר.
	...
	// שני אלה הוא בדיוק totalPending — הבועות על האריחים, על תמונת
