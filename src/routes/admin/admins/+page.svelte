...
<div class="max-w-3xl space-y-5">
    ...
    {#if flash && flashText[flash]}<div class="rounded-xl border border-emerald-400/60 bg-emerald-900 px-4 py-2.5 text-sm font-medium text-emerald-50 shadow-lg">{flashText[flash]}</div>{/if}
    {#if form?.error}<div class="rounded-xl border border-red-400/70 bg-red-950 px-4 py-3 text-sm font-medium text-red-50 shadow-lg break-words" dir="rtl">{form.error}</div>{/if}
