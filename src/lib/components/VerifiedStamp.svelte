...
{#if size === 'md'}
    <span
        class="inline-flex -rotate-6 select-none flex-col items-center rounded-lg border-2 border-emerald-400/80 px-2.5 py-1 leading-none"
        style="box-shadow: inset 0 0 0 2px rgba(16,185,129,0.25);"
...
{:else}
    <span
        class="inline-flex -rotate-3 select-none items-center gap-1 rounded-md border border-emerald-400/70 bg-emerald-500/10 px-1.5 py-0.5 text-[11px] font-black tracking-wide text-emerald-300 leading-none"
        title="הגמ&quot;ח עבר בדיקת מערכת ואושר"
        aria-label="גמ&quot;ח מאושר — עבר בדיקת מערכת"
    >✓ מאושר</span>
{/if}
