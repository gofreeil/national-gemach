...
function messageFor(name, url) {
    return [
        ...
        `חדש: מעכשיו אפשר לקבל תרומות דרך הכרטיס של "${name}" באתר — ביט, פייבוקס, העברה בנקאית, הוראת קבע או קישור לדף תרומות. אפשר כמה דרכים במקביל.`,
        'היכנסו לכרטיס, לחצו "ערוך" (או "כן, זה הגמ"ח שלי" אם עוד לא נרשמתם), והוסיפו את דרכי התרומה. לוקח דקה:',
        url,
        'להסרה מהודעות — השיבו "הסר".',
    ].join('\n');
}
