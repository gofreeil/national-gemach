...
// פנייה ישירה לנמען — בלי שם הגמ"ח בגוף ההודעה (הקישור ממילא מוביל לכרטיס שלו).
function messageFor(_name, url) {
    return [
        ...
        'היכנסו לכרטיס שלכם, לחצו "ערוך" (או "כן, זה הגמ"ח שלי" אם עוד לא נרשמתם), והוסיפו את דרכי התרומה. לוקח דקה:',
        url,
        'להסרה — השיבו "הסר".',
    ].join('\n');
}
